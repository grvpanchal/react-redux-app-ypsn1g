System.register(["react"], function(__WEBPACK_DYNAMIC_EXPORT__) {
	var __WEBPACK_EXTERNAL_MODULE__0__;
	return {
		setters: [
			function(module) {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "store", function() { return /* binding */ App_store; });
...
var _freeGlobal = __webpack_require__(6);
...
var connectAdvanced_extends = Object.assign || function (target) {
  for (var i = 1; i < arguments.length; i++) {
    var source = arguments[i];
...
var nextTodoId=0;var addTodo=function addTodo(text){return{type:'ADD_TODO',id:nextTodoId++,text:text};};var setVisibilityFilter=function setVisibilityFilter(filter){return{type:'SET_VISIBILITY_FILTER',filter:filter};};var actions_toggleTodo=function toggleTodo(id){return{type:'TOGGLE_TODO',id:id};};var VisibilityFilters={SHOW_ALL:'SHOW_ALL',SHOW_COMPLETED:'SHOW_COMPLETED',SHOW_ACTIVE:'SHOW_ACTIVE'};
// CONCATENATED MODULE: ./src/components/Link.js
var Link_Link=function Link(_ref){var active=_ref.active,children=_ref.children,onClick=_ref.onClick;return/*#__PURE__*/external_react_default.a.createElement("a",{href:"#",className:"btn btn-default",onClick:onClick,disabled:active,role:"button"},children);};/* harmony default export */ var components_Link = (Link_Link);
// CONCATENATED MODULE: ./src/containers/FilterLink.js
var FilterLink_mapStateToProps=function mapStateToProps(state,ownProps){return{active:ownProps.filter===state.visibilityFilter};};var FilterLink_mapDispatchToProps=function mapDispatchToProps(dispatch,ownProps){return{onClick:function onClick(){return dispatch(setVisibilityFilter(ownProps.filter));}};};/* harmony default export */ var FilterLink = (connect_connect(FilterLink_mapStateToProps,FilterLink_mapDispatchToProps)(components_Link));
// CONCATENATED MODULE: ./src/components/Footer.js
var Footer_Footer=function Footer(){return/*#__PURE__*/external_react_default.a.createElement("div",{class:"btn-group btn-group-justified",role:"group"},/*#__PURE__*/external_react_default.a.createElement(FilterLink,{filter:VisibilityFilters.SHOW_ALL},"All"),/*#__PURE__*/external_react_default.a.createElement(FilterLink,{filter:VisibilityFilters.SHOW_ACTIVE},"Active"),/*#__PURE__*/external_react_default.a.createElement(FilterLink,{filter:VisibilityFilters.SHOW_COMPLETED},"Completed"));};/* harmony default export */ var components_Footer = (Footer_Footer);
// CONCATENATED MODULE: ./src/containers/AddTodo.js
var AddTodo_AddTodo=function AddTodo(_ref){var dispatch=_ref.dispatch;var input;return/*#__PURE__*/external_react_default.a.createElement("div",null,/*#__PURE__*/external_react_default.a.createElement("form",{onSubmit:function onSubmit(e){e.preventDefault();if(!input.value.trim()){return;}dispatch(addTodo(input.value));input.value='';}},/*#__PURE__*/external_react_default.a.createElement("div",{className:"input-group"},/*#__PURE__*/external_react_default.a.createElement("input",{className:"form-control",ref:function ref(node){return input=node;}}),/*#__PURE__*/external_react_default.a.createElement("span",{className:"input-group-btn"},/*#__PURE__*/external_react_default.a.createElement("button",{className:"btn btn-default",type:"submit"},"Add Todo")))));};/* harmony default export */ var containers_AddTodo = (connect_connect()(AddTodo_AddTodo));
// CONCATENATED MODULE: ./src/components/Todo.js
var Todo_Todo=function Todo(_ref){var onClick=_ref.onClick,completed=_ref.completed,text=_ref.text;return/*#__PURE__*/external_react_default.a.createElement("li",{className:"list-group-item",onClick:onClick,style:{textDecoration:completed?'line-through':'none'}},text);};/* harmony default export */ var components_Todo = (Todo_Todo);
// CONCATENATED MODULE: ./src/components/TodoList.js
var TodoList_TodoList=function TodoList(_ref){var todos=_ref.todos,toggleTodo=_ref.toggleTodo;return/*#__PURE__*/external_react_default.a.createElement("ul",{className:"list-group"},todos.map(function(todo){return/*#__PURE__*/external_react_default.a.createElement(components_Todo,Object.assign({key:todo.id},todo,{onClick:function onClick(){return toggleTodo(todo.id);}}));}));};/* harmony default export */ var components_TodoList = (TodoList_TodoList);
// CONCATENATED MODULE: ./src/containers/VisibleTodoList.js
var getVisibleTodos=function getVisibleTodos(todos,filter){switch(filter){case'SHOW_ALL':return todos;case'SHOW_COMPLETED':return todos.filter(function(t){return t.completed;});case'SHOW_ACTIVE':return todos.filter(function(t){return!t.completed;});default:throw new Error('Unknown filter: '+filter);}};var VisibleTodoList_mapStateToProps=function mapStateToProps(state){return{todos:getVisibleTodos(state.todos,state.visibilityFilter)};};var VisibleTodoList_mapDispatchToProps=function mapDispatchToProps(dispatch){return{toggleTodo:function toggleTodo(id){return dispatch(actions_toggleTodo(id));}};};/* harmony default export */ var VisibleTodoList = (connect_connect(VisibleTodoList_mapStateToProps,VisibleTodoList_mapDispatchToProps)(components_TodoList));
...
var todos_todos=function todos(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:[];var action=arguments.length>1?arguments[1]:undefined;switch(action.type){case'ADD_TODO':return[].concat(_toConsumableArray(state),[{id:action.id,text:action.text,completed:false}]);case'TOGGLE_TODO':return state.map(function(todo){return todo.id===action.id?_objectSpread2(_objectSpread2({},todo),{},{completed:!todo.completed}):todo;});default:return state;}};/* harmony default export */ var reducers_todos = (todos_todos);
// CONCATENATED MODULE: ./src/reducers/visibilityFilter.js
var visibilityFilter=function visibilityFilter(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'SHOW_ALL';var action=arguments.length>1?arguments[1]:undefined;switch(action.type){case'SET_VISIBILITY_FILTER':return action.filter;default:return state;}};/* harmony default export */ var reducers_visibilityFilter = (visibilityFilter);
// CONCATENATED MODULE: ./src/reducers/index.js
/* harmony default export */ var src_reducers = (combineReducers({todos:reducers_todos,visibilityFilter:reducers_visibilityFilter}));
// CONCATENATED MODULE: ./src/components/App.js
var App_store=createStore_createStore(src_reducers);var App_App=function App(){return/*#__PURE__*/external_react_default.a.createElement("div",{className:"container",style:{maxWidth:'330px'}},/*#__PURE__*/external_react_default.a.createElement("br",null),/*#__PURE__*/external_react_default.a.createElement("br",null),/*#__PURE__*/external_react_default.a.createElement("h1",{className:"text-center"},"Todo App"),/*#__PURE__*/external_react_default.a.createElement("br",null),/*#__PURE__*/external_react_default.a.createElement(containers_AddTodo,null),/*#__PURE__*/external_react_default.a.createElement("br",null),/*#__PURE__*/external_react_default.a.createElement(VisibleTodoList,null),/*#__PURE__*/external_react_default.a.createElement(components_Footer,null));};/* harmony default export */ var components_App = __webpack_exports__["default"] = (App_App);
...
//# sourceMappingURL=mfe-app.system.js.map